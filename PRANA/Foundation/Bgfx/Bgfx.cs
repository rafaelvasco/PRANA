...
namespace PRANA.Foundation.BGFX;
...
{
#if DEBUG
    private const string dll = "BGFXD.dll";
#else
       const string dll = "BGFX.dll";
#endif
	...
	public enum TopologyConvertType
	{
		/// <summary>
	...
	///
	[DllImport(dll, EntryPoint="bgfx_attachment_init", CallingConvention = CallingConvention.Cdecl)]
	public static extern void AttachmentInit(Attachment* _this, TextureHandle _handle, Access _access, ushort _layer, ushort _numLayers, ushort _mip, byte _resolve);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_vertex_layout_begin", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_vertex_layout_add", CallingConvention = CallingConvention.Cdecl)]
	public static extern VertexLayout* VertexLayoutAdd(VertexLayout* _this, Attrib _attrib, byte _num, AttribType _type, bool _normalized, bool _asInt);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_vertex_layout_decode", CallingConvention = CallingConvention.Cdecl)]
	public static extern void VertexLayoutDecode(VertexLayout* _this, Attrib _attrib, byte * _num, AttribType* _type, bool* _normalized, bool* _asInt);
	...
	/// <param name="_attrib">Attribute semantics. See: `bgfx::Attrib`</param>
	///
	[DllImport(dll, EntryPoint="bgfx_vertex_layout_has", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_vertex_layout_skip", CallingConvention = CallingConvention.Cdecl)]
	public static extern VertexLayout* VertexLayoutSkip(VertexLayout* _this, byte _num);
	
	/// <summary>
	/// End VertexLayout.
	/// </summary>
	///
	[DllImport(dll, EntryPoint="bgfx_vertex_layout_end", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_vertex_pack", CallingConvention = CallingConvention.Cdecl)]
	public static extern void VertexPack(float _input, bool _inputNormalized, Attrib _attr, VertexLayout* _layout, void* _data, uint _index);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_vertex_unpack", CallingConvention = CallingConvention.Cdecl)]
	public static extern void VertexUnpack(float _output, Attrib _attr, VertexLayout* _layout, void* _data, uint _index);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_vertex_convert", CallingConvention = CallingConvention.Cdecl)]
	public static extern void VertexConvert(VertexLayout* _dstLayout, void* _dstData, VertexLayout* _srcLayout, void* _srcData, uint _num);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_weld_vertices", CallingConvention = CallingConvention.Cdecl)]
	public static extern uint WeldVertices(void* _output, VertexLayout* _layout, void* _data, uint _num, bool _index32, float _epsilon);
	...
	/// <param name="_index32">Set to `true` if input indices are 32-bit.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_topology_convert", CallingConvention = CallingConvention.Cdecl)]
	public static extern uint TopologyConvert(TopologyConvertType _conversion, void* _dst, uint _dstSize, void* _indices, uint _numIndices, bool _index32);
	...
	/// <param name="_index32">Set to `true` if input indices are 32-bit.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_topology_sort_tri_list", CallingConvention = CallingConvention.Cdecl)]
	public static extern void TopologySortTriList(TopologySort _sort, void* _dst, uint _dstSize, float _dir, float _pos, void* _vertices, uint _stride, void* _indices, uint _numIndices, bool _index32);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_get_supported_renderers", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_get_renderer_name", CallingConvention = CallingConvention.Cdecl)]
	public static extern IntPtr GetRendererName(RendererType _type);
	
	[DllImport(dll, EntryPoint="bgfx_init_ctor", CallingConvention = CallingConvention.Cdecl)]
	public static extern void init_ctor(InitData* _init);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_init", CallingConvention = CallingConvention.Cdecl)]
	[return: MarshalAs(UnmanagedType.I1)]
	public static extern bool Init(InitData* _init);
	
	/// <summary>
	/// Shutdown bgfx library.
	/// </summary>
	///
	[DllImport(dll, EntryPoint="bgfx_shutdown", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_reset", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_frame", CallingConvention = CallingConvention.Cdecl)]
	...
	/// </summary>
	///
	[DllImport(dll, EntryPoint="bgfx_get_renderer_type", CallingConvention = CallingConvention.Cdecl)]
	...
	/// </summary>
	///
	[DllImport(dll, EntryPoint="bgfx_get_caps", CallingConvention = CallingConvention.Cdecl)]
	...
	/// </summary>
	///
	[DllImport(dll, EntryPoint="bgfx_get_stats", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_alloc", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_copy", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_make_ref", CallingConvention = CallingConvention.Cdecl)]
	public static extern Memory* MakeRef(void* _data, uint _size);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_make_ref_release", CallingConvention = CallingConvention.Cdecl)]
	public static extern Memory* MakeRefRelease(void* _data, uint _size, IntPtr _releaseFn, void* _userData);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_debug", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_dbg_text_clear", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_dbg_text_printf", CallingConvention = CallingConvention.Cdecl)]
	public static extern void DbgTextPrintf(ushort _x, ushort _y, byte _attr, [MarshalAs(UnmanagedType.LPStr)] string _format, [MarshalAs(UnmanagedType.LPStr)] string args );
	...
	///
	[DllImport(dll, EntryPoint="bgfx_dbg_text_vprintf", CallingConvention = CallingConvention.Cdecl)]
	public static extern void DbgTextVprintf(ushort _x, ushort _y, byte _attr, [MarshalAs(UnmanagedType.LPStr)] string _format, IntPtr _argList);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_dbg_text_image", CallingConvention = CallingConvention.Cdecl)]
	public static extern void DbgTextImage(ushort _x, ushort _y, ushort _width, ushort _height, void* _data, ushort _pitch);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_create_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern IndexBufferHandle CreateIndexBuffer(Memory* _mem, ushort _flags);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_index_buffer_name", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetIndexBufferName(IndexBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	...
	/// <param name="_handle">Static index buffer handle.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_destroy_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_create_vertex_layout", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_destroy_vertex_layout", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_flags">Buffer creation flags.  - `BGFX_BUFFER_NONE` - No flags.  - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.  - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer      is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.  - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.  - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of      data is passed. If this flag is not specified, and more data is passed on update, the buffer      will be trimmed to fit the existing buffer size. This flag has effect only on dynamic buffers.  - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on index buffers.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_create_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern VertexBufferHandle CreateVertexBuffer(Memory* _mem, VertexLayout* _layout, ushort _flags);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_vertex_buffer_name", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetVertexBufferName(VertexBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	...
	/// <param name="_handle">Static vertex buffer handle.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_destroy_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_flags">Buffer creation flags.   - `BGFX_BUFFER_NONE` - No flags.   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of       data is passed. If this flag is not specified, and more data is passed on update, the buffer       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic       buffers.   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on       index buffers.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_create_dynamic_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern DynamicIndexBufferHandle CreateDynamicIndexBuffer(uint _num, ushort _flags);
	...
	/// <param name="_flags">Buffer creation flags.   - `BGFX_BUFFER_NONE` - No flags.   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of       data is passed. If this flag is not specified, and more data is passed on update, the buffer       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic       buffers.   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on       index buffers.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_create_dynamic_index_buffer_mem", CallingConvention = CallingConvention.Cdecl)]
	public static extern DynamicIndexBufferHandle CreateDynamicIndexBufferMem(Memory* _mem, ushort _flags);
	...
	/// <param name="_mem">Index buffer data.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_update_dynamic_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void UpdateDynamicIndexBuffer(DynamicIndexBufferHandle _handle, uint _startIndex, Memory* _mem);
	...
	/// <param name="_handle">Dynamic index buffer handle.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_destroy_dynamic_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_flags">Buffer creation flags.   - `BGFX_BUFFER_NONE` - No flags.   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of       data is passed. If this flag is not specified, and more data is passed on update, the buffer       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic       buffers.   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on       index buffers.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_create_dynamic_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern DynamicVertexBufferHandle CreateDynamicVertexBuffer(uint _num, VertexLayout* _layout, ushort _flags);
	...
	/// <param name="_flags">Buffer creation flags.   - `BGFX_BUFFER_NONE` - No flags.   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of       data is passed. If this flag is not specified, and more data is passed on update, the buffer       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic       buffers.   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on       index buffers.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_create_dynamic_vertex_buffer_mem", CallingConvention = CallingConvention.Cdecl)]
	public static extern DynamicVertexBufferHandle CreateDynamicVertexBufferMem(Memory* _mem, VertexLayout* _layout, ushort _flags);
	...
	/// <param name="_mem">Vertex buffer data.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_update_dynamic_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void UpdateDynamicVertexBuffer(DynamicVertexBufferHandle _handle, uint _startVertex, Memory* _mem);
	...
	/// <param name="_handle">Dynamic vertex buffer handle.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_destroy_dynamic_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_get_avail_transient_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern uint GetAvailTransientIndexBuffer(uint _num, bool _index32);
	...
	/// <param name="_layout">Vertex layout.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_get_avail_transient_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern uint GetAvailTransientVertexBuffer(uint _num, VertexLayout* _layout);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_get_avail_instance_data_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern uint GetAvailInstanceDataBuffer(uint _num, ushort _stride);
	...
	/// <param name="_index32">Set to `true` if input indices will be 32-bit.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_alloc_transient_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void AllocTransientIndexBuffer(TransientIndexBuffer* _tib, uint _num, bool _index32);
	...
	/// <param name="_layout">Vertex layout.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_alloc_transient_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void AllocTransientVertexBuffer(TransientVertexBuffer* _tvb, uint _num, VertexLayout* _layout);
	...
	/// <param name="_index32">Set to `true` if input indices will be 32-bit.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_alloc_transient_buffers", CallingConvention = CallingConvention.Cdecl)]
	[return: MarshalAs(UnmanagedType.I1)]
	public static extern bool AllocTransientBuffers(TransientVertexBuffer* _tvb, VertexLayout* _layout, uint _numVertices, TransientIndexBuffer* _tib, uint _numIndices, bool _index32);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_alloc_instance_data_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void AllocInstanceDataBuffer(InstanceDataBuffer* _idb, uint _num, ushort _stride);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_create_indirect_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern IndirectBufferHandle CreateIndirectBuffer(uint _num);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_destroy_indirect_buffer", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_create_shader", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_get_shader_uniforms", CallingConvention = CallingConvention.Cdecl)]
	public static extern ushort GetShaderUniforms(ShaderHandle _handle, UniformHandle* _uniforms, ushort _max);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_shader_name", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetShaderName(ShaderHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	...
	/// <param name="_handle">Shader handle.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_destroy_shader", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_create_program", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_destroyShaders">If true, shaders will be destroyed when program is destroyed.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_create_compute_program", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_destroy_program", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_is_texture_valid", CallingConvention = CallingConvention.Cdecl)]
	[return: MarshalAs(UnmanagedType.I1)]
	public static extern bool IsTextureValid(ushort _depth, bool _cubeMap, ushort _numLayers, TextureFormat _format, ulong _flags);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_is_frame_buffer_valid", CallingConvention = CallingConvention.Cdecl)]
	[return: MarshalAs(UnmanagedType.I1)]
	public static extern bool IsFrameBufferValid(byte _num, Attachment* _attachment);
	...
	/// <param name="_format">Texture format. See: `TextureFormat::Enum`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_calc_texture_size", CallingConvention = CallingConvention.Cdecl)]
	public static extern void CalcTextureSize(TextureInfo* _info, ushort _width, ushort _height, ushort _depth, bool _cubeMap, bool _hasMips, ushort _numLayers, TextureFormat _format);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_create_texture", CallingConvention = CallingConvention.Cdecl)]
	public static extern TextureHandle CreateTexture(Memory* _mem, ulong _flags, byte _skip, TextureInfo* _info);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_create_texture_2d", CallingConvention = CallingConvention.Cdecl)]
	public static extern TextureHandle CreateTexture2D(ushort _width, ushort _height, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags, Memory* _mem);
	...
	/// <param name="_flags">Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`) flags. Default texture sampling mode is linear, and wrap mode is repeat. - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap   mode. - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic   sampling.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_create_texture_2d_scaled", CallingConvention = CallingConvention.Cdecl)]
	public static extern TextureHandle CreateTexture2DScaled(BackbufferRatio _ratio, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags);
	...
	/// <param name="_mem">Texture data. If `_mem` is non-NULL, created texture will be immutable. If `_mem` is NULL content of the texture is uninitialized. When `_numLayers` is more than 1, expected memory layout is texture and all mips together for each array element.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_create_texture_3d", CallingConvention = CallingConvention.Cdecl)]
	public static extern TextureHandle CreateTexture3D(ushort _width, ushort _height, ushort _depth, bool _hasMips, TextureFormat _format, ulong _flags, Memory* _mem);
	...
	/// <param name="_mem">Texture data. If `_mem` is non-NULL, created texture will be immutable. If `_mem` is NULL content of the texture is uninitialized. When `_numLayers` is more than 1, expected memory layout is texture and all mips together for each array element.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_create_texture_cube", CallingConvention = CallingConvention.Cdecl)]
	public static extern TextureHandle CreateTextureCube(ushort _size, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags, Memory* _mem);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_update_texture_2d", CallingConvention = CallingConvention.Cdecl)]
	public static extern void UpdateTexture2D(TextureHandle _handle, ushort _layer, byte _mip, ushort _x, ushort _y, ushort _width, ushort _height, Memory* _mem, ushort _pitch);
	...
	/// <param name="_mem">Texture update data.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_update_texture_3d", CallingConvention = CallingConvention.Cdecl)]
	public static extern void UpdateTexture3D(TextureHandle _handle, byte _mip, ushort _x, ushort _y, ushort _z, ushort _width, ushort _height, ushort _depth, Memory* _mem);
	...
	/// <param name="_pitch">Pitch of input image (bytes). When _pitch is set to UINT16_MAX, it will be calculated internally based on _width.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_update_texture_cube", CallingConvention = CallingConvention.Cdecl)]
	public static extern void UpdateTextureCube(TextureHandle _handle, ushort _layer, byte _side, byte _mip, ushort _x, ushort _y, ushort _width, ushort _height, Memory* _mem, ushort _pitch);
	...
	/// <param name="_mip">Mip level.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_read_texture", CallingConvention = CallingConvention.Cdecl)]
	public static extern uint ReadTexture(TextureHandle _handle, void* _data, byte _mip);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_texture_name", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetTextureName(TextureHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	...
	/// <param name="_handle">Texture handle.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_get_direct_access_ptr", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_handle">Texture handle.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_destroy_texture", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_create_frame_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern FrameBufferHandle CreateFrameBuffer(ushort _width, ushort _height, TextureFormat _format, ulong _textureFlags);
	...
	/// <param name="_textureFlags">Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`) flags. Default texture sampling mode is linear, and wrap mode is repeat. - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap   mode. - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic   sampling.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_create_frame_buffer_scaled", CallingConvention = CallingConvention.Cdecl)]
	public static extern FrameBufferHandle CreateFrameBufferScaled(BackbufferRatio _ratio, TextureFormat _format, ulong _textureFlags);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_create_frame_buffer_from_handles", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_destroyTexture">If true, textures will be destroyed when frame buffer is destroyed.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_create_frame_buffer_from_attachment", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_create_frame_buffer_from_nwh", CallingConvention = CallingConvention.Cdecl)]
	public static extern FrameBufferHandle CreateFrameBufferFromNwh(void* _nwh, ushort _width, ushort _height, TextureFormat _format, TextureFormat _depthFormat);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_frame_buffer_name", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetFrameBufferName(FrameBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	...
	/// <param name="_handle">Frame buffer handle.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_get_texture", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_handle">Frame buffer handle.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_destroy_frame_buffer", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_create_uniform", CallingConvention = CallingConvention.Cdecl)]
	public static extern UniformHandle CreateUniform([MarshalAs(UnmanagedType.LPStr)] string _name, UniformType _type, ushort _num);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_get_uniform_info", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_handle">Handle to uniform object.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_destroy_uniform", CallingConvention = CallingConvention.Cdecl)]
	...
	/// </summary>
	///
	[DllImport(dll, EntryPoint="bgfx_create_occlusion_query", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_get_result", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_handle">Handle to occlusion query object.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_destroy_occlusion_query", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_palette_color", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_palette_color_rgba8", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetPaletteColorRgba8(byte _index, uint _rgba);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_view_name", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetViewName(ushort _id, [MarshalAs(UnmanagedType.LPStr)] string _name);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_view_rect", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetViewRect(ushort _id, ushort _x, ushort _y, ushort _width, ushort _height);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_view_rect_ratio", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetViewRectRatio(ushort _id, ushort _x, ushort _y, BackbufferRatio _ratio);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_view_scissor", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetViewScissor(ushort _id, ushort _x, ushort _y, ushort _width, ushort _height);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_view_clear", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_view_clear_mrt", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetViewClearMrt(ushort _id, ushort _flags, float _depth, byte _stencil, byte _c0, byte _c1, byte _c2, byte _c3, byte _c4, byte _c5, byte _c6, byte _c7);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_view_mode", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_view_frame_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetViewFrameBuffer(ushort _id, FrameBufferHandle _handle);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_view_transform", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetViewTransform(ushort _id, void* _view, void* _proj);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_view_order", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetViewOrder(ushort _id, ushort _num, ushort* _order);
	
	/// <summary>
	/// Reset all view settings to default.
	/// </summary>
	///
	[DllImport(dll, EntryPoint="bgfx_reset_view", CallingConvention = CallingConvention.Cdecl)]
	public static extern void ResetView(ushort _id);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_begin", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_end", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_marker", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetMarker(Encoder* _this, [MarshalAs(UnmanagedType.LPStr)] string _marker);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_state", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetState(Encoder* _this, ulong _state, uint _rgba);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_condition", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_stencil", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetStencil(Encoder* _this, uint _fstencil, uint _bstencil);
	...
	/// <param name="_height">Height of view scissor region.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_scissor", CallingConvention = CallingConvention.Cdecl)]
	public static extern ushort EncoderSetScissor(Encoder* _this, ushort _x, ushort _y, ushort _width, ushort _height);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_scissor_cached", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetScissorCached(Encoder* _this, ushort _cache);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_transform", CallingConvention = CallingConvention.Cdecl)]
	public static extern uint EncoderSetTransform(Encoder* _this, void* _mtx, ushort _num);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_transform_cached", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetTransformCached(Encoder* _this, uint _cache, ushort _num);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_alloc_transform", CallingConvention = CallingConvention.Cdecl)]
	public static extern uint EncoderAllocTransform(Encoder* _this, Transform* _transform, ushort _num);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_uniform", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetUniform(Encoder* _this, UniformHandle _handle, void* _value, ushort _num);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetIndexBuffer(Encoder* _this, IndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
	...
	/// <param name="_numIndices">Number of indices to render.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_dynamic_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetDynamicIndexBuffer(Encoder* _this, DynamicIndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
	...
	/// <param name="_numIndices">Number of indices to render.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_transient_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetTransientIndexBuffer(Encoder* _this, TransientIndexBuffer* _tib, uint _firstIndex, uint _numIndices);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetVertexBuffer(Encoder* _this, byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_vertex_buffer_with_layout", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetVertexBufferWithLayout(Encoder* _this, byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	...
	/// <param name="_numVertices">Number of vertices to render.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_dynamic_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetDynamicVertexBuffer(Encoder* _this, byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices);
	
	[DllImport(dll, EntryPoint="bgfx_encoder_set_dynamic_vertex_buffer_with_layout", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetDynamicVertexBufferWithLayout(Encoder* _this, byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	...
	/// <param name="_numVertices">Number of vertices to render.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_transient_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetTransientVertexBuffer(Encoder* _this, byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices);
	...
	/// <param name="_layoutHandle">Vertex layout for aliasing vertex buffer. If invalid handle is used, vertex layout used for creation of vertex buffer will be used.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_transient_vertex_buffer_with_layout", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetTransientVertexBufferWithLayout(Encoder* _this, byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_vertex_count", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetVertexCount(Encoder* _this, uint _numVertices);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_instance_data_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetInstanceDataBuffer(Encoder* _this, InstanceDataBuffer* _idb, uint _start, uint _num);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_instance_data_from_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetInstanceDataFromVertexBuffer(Encoder* _this, VertexBufferHandle _handle, uint _startVertex, uint _num);
	...
	/// <param name="_num">Number of data instances.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_instance_data_from_dynamic_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetInstanceDataFromDynamicVertexBuffer(Encoder* _this, DynamicVertexBufferHandle _handle, uint _startVertex, uint _num);
	...
	/// </summary>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_instance_count", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetInstanceCount(Encoder* _this, uint _numInstances);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_texture", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetTexture(Encoder* _this, byte _stage, UniformHandle _sampler, TextureHandle _handle, uint _flags);
	...
	/// <param name="_id">View id.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_touch", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderTouch(Encoder* _this, ushort _id);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_submit", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSubmit(Encoder* _this, ushort _id, ProgramHandle _program, uint _depth, byte _flags);
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_submit_occlusion_query", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSubmitOcclusionQuery(Encoder* _this, ushort _id, ProgramHandle _program, OcclusionQueryHandle _occlusionQuery, uint _depth, byte _flags);
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_submit_indirect", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSubmitIndirect(Encoder* _this, ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, uint _depth, byte _flags);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_compute_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetComputeIndexBuffer(Encoder* _this, byte _stage, IndexBufferHandle _handle, Access _access);
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_compute_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetComputeVertexBuffer(Encoder* _this, byte _stage, VertexBufferHandle _handle, Access _access);
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_compute_dynamic_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetComputeDynamicIndexBuffer(Encoder* _this, byte _stage, DynamicIndexBufferHandle _handle, Access _access);
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_compute_dynamic_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetComputeDynamicVertexBuffer(Encoder* _this, byte _stage, DynamicVertexBufferHandle _handle, Access _access);
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_compute_indirect_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetComputeIndirectBuffer(Encoder* _this, byte _stage, IndirectBufferHandle _handle, Access _access);
	...
	/// <param name="_format">Texture format. See: `TextureFormat::Enum`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_set_image", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderSetImage(Encoder* _this, byte _stage, TextureHandle _handle, byte _mip, Access _access, TextureFormat _format);
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_dispatch", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderDispatch(Encoder* _this, ushort _id, ProgramHandle _program, uint _numX, uint _numY, uint _numZ, byte _flags);
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_dispatch_indirect", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderDispatchIndirect(Encoder* _this, ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, byte _flags);
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_discard", CallingConvention = CallingConvention.Cdecl)]
	public static extern void encoder_discard(Encoder* _this, byte _flags);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_encoder_blit", CallingConvention = CallingConvention.Cdecl)]
	public static extern void EncoderBlit(Encoder* _this, ushort _id, TextureHandle _dst, byte _dstMip, ushort _dstX, ushort _dstY, ushort _dstZ, TextureHandle _src, byte _srcMip, ushort _srcX, ushort _srcY, ushort _srcZ, ushort _width, ushort _height, ushort _depth);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_request_screen_shot", CallingConvention = CallingConvention.Cdecl)]
	public static extern void RequestScreenShot(FrameBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _filePath);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_render_frame", CallingConvention = CallingConvention.Cdecl)]
	public static extern RenderFrameType RenderFrame(int _msecs);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_set_platform_data", CallingConvention = CallingConvention.Cdecl)]
	...
	/// </summary>
	///
	[DllImport(dll, EntryPoint="bgfx_get_internal_data", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_override_internal_texture_ptr", CallingConvention = CallingConvention.Cdecl)]
	public static extern UIntPtr OverrideInternalTexturePtr(TextureHandle _handle, UIntPtr _ptr);
	...
	/// <param name="_flags">Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`) flags. Default texture sampling mode is linear, and wrap mode is repeat. - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap   mode. - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic   sampling.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_override_internal_texture", CallingConvention = CallingConvention.Cdecl)]
	public static extern UIntPtr OverrideInternalTexture(TextureHandle _handle, ushort _width, ushort _height, byte _numMips, TextureFormat _format, ulong _flags);
	...
	/// <param name="_marker">Marker string.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_marker", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetMarker([MarshalAs(UnmanagedType.LPStr)] string _marker);
	...
	/// <param name="_rgba">Sets blend factor used by `BGFX_STATE_BLEND_FACTOR` and   `BGFX_STATE_BLEND_INV_FACTOR` blend modes.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_state", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetState(ulong _state, uint _rgba);
	...
	/// <param name="_visible">Render if occlusion query is visible.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_condition", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_bstencil">Back stencil state. If back is set to `BGFX_STENCIL_NONE` _fstencil is applied to both front and back facing primitives.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_stencil", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetStencil(uint _fstencil, uint _bstencil);
	...
	/// <param name="_height">Height of view scissor region.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_scissor", CallingConvention = CallingConvention.Cdecl)]
	public static extern ushort SetScissor(ushort _x, ushort _y, ushort _width, ushort _height);
	...
	/// <param name="_cache">Index in scissor cache.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_scissor_cached", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetScissorCached(ushort _cache);
	...
	/// <param name="_num">Number of matrices in array.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_transform", CallingConvention = CallingConvention.Cdecl)]
	public static extern uint SetTransform(void* _mtx, ushort _num);
	...
	/// <param name="_num">Number of matrices from cache.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_transform_cached", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetTransformCached(uint _cache, ushort _num);
	...
	/// <param name="_num">Number of matrices.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_alloc_transform", CallingConvention = CallingConvention.Cdecl)]
	public static extern uint AllocTransform(Transform* _transform, ushort _num);
	...
	/// <param name="_num">Number of elements. Passing `UINT16_MAX` will use the _num passed on uniform creation.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_uniform", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetUniform(UniformHandle _handle, void* _value, ushort _num);
	...
	/// <param name="_numIndices">Number of indices to render.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_numIndices">Number of indices to render.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_dynamic_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetDynamicIndexBuffer(DynamicIndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
	...
	/// <param name="_numIndices">Number of indices to render.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_transient_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetTransientIndexBuffer(TransientIndexBuffer* _tib, uint _firstIndex, uint _numIndices);
	...
	/// <param name="_numVertices">Number of vertices to render.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetVertexBuffer(byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices);
	...
	/// <param name="_layoutHandle">Vertex layout for aliasing vertex buffer. If invalid handle is used, vertex layout used for creation of vertex buffer will be used.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_vertex_buffer_with_layout", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetVertexBufferWithLayout(byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	...
	/// <param name="_numVertices">Number of vertices to render.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_dynamic_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetDynamicVertexBuffer(byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices);
	...
	/// <param name="_layoutHandle">Vertex layout for aliasing vertex buffer. If invalid handle is used, vertex layout used for creation of vertex buffer will be used.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_dynamic_vertex_buffer_with_layout", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetDynamicVertexBufferWithLayout(byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	...
	/// <param name="_numVertices">Number of vertices to render.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_transient_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetTransientVertexBuffer(byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices);
	...
	/// <param name="_layoutHandle">Vertex layout for aliasing vertex buffer. If invalid handle is used, vertex layout used for creation of vertex buffer will be used.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_transient_vertex_buffer_with_layout", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetTransientVertexBufferWithLayout(byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	...
	/// <param name="_numVertices">Number of vertices.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_vertex_count", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_num">Number of data instances.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_instance_data_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetInstanceDataBuffer(InstanceDataBuffer* _idb, uint _start, uint _num);
	...
	/// <param name="_num">Number of data instances. Set instance data buffer for draw primitive.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_instance_data_from_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetInstanceDataFromVertexBuffer(VertexBufferHandle _handle, uint _startVertex, uint _num);
	...
	/// <param name="_num">Number of data instances.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_instance_data_from_dynamic_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetInstanceDataFromDynamicVertexBuffer(DynamicVertexBufferHandle _handle, uint _startVertex, uint _num);
	...
	/// </summary>
	///
	[DllImport(dll, EntryPoint="bgfx_set_instance_count", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_flags">Texture sampling mode. Default value UINT32_MAX uses   texture sampling settings from the texture.   - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap     mode.   - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic     sampling.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_texture", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_id">View id.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_touch", CallingConvention = CallingConvention.Cdecl)]
	...
	///
	[DllImport(dll, EntryPoint="bgfx_submit", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_flags">Which states to discard for next draw. See `BGFX_DISCARD_*`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_submit_occlusion_query", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SubmitOcclusionQuery(ushort _id, ProgramHandle _program, OcclusionQueryHandle _occlusionQuery, uint _depth, byte _flags);
	...
	/// <param name="_flags">Which states to discard for next draw. See `BGFX_DISCARD_*`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_submit_indirect", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SubmitIndirect(ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, uint _depth, byte _flags);
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_compute_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_compute_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_compute_dynamic_index_buffer", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_compute_dynamic_vertex_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern void SetComputeDynamicVertexBuffer(byte _stage, DynamicVertexBufferHandle _handle, Access _access);
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_compute_indirect_buffer", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_format">Texture format. See: `TextureFormat::Enum`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_set_image", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_dispatch", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_dispatch_indirect", CallingConvention = CallingConvention.Cdecl)]
	public static extern void DispatchIndirect(ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, byte _flags);
	...
	///
	[DllImport(dll, EntryPoint="bgfx_discard", CallingConvention = CallingConvention.Cdecl)]
	...
	/// <param name="_depth">If texture is 3D this argument represents depth of region, otherwise it's unused.</param>
	///
	[DllImport(dll, EntryPoint="bgfx_blit", CallingConvention = CallingConvention.Cdecl)]
